...
const Card = ({ handleDelete, title, subText, type, icon, className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 bg-red-300 rounded p-1 mx-4 group-hover:opacity-100 opacity-0 transition-all duration-700">
        <IoTrashOutline
          size={18}
