...
const TranslationArabic = {
  ...
  RegisterPage: {
    ...
    fields1: [
      ...
      },
      {
        ...
        type: "password",
        name: "confirmPassword",
        validation: { validate: "كلمات المرور لا تطابق" },
      },
      { label: "رقم الهاتف", type: "number", name: "phone" },
    ],
    fields2: [
  ...
  EstimationPage: {
    ...
    table: ["الاسم", "اسم المشروع", "العقد", "التطبيق على", "حذف"],
    sureDelete: {
      buttons: {
        backButton: "رجوع",
        deleteButton: {
      ...
      form: {
        ...
        fields: [
          ...
          },
          {
            ...
            errorMessage: "الكمية السابقة مطلوبة",
          },
          {
            label: "الكمية المتبقية",
            type: "number",
            name: "remainingQuantity",
            errorMessage: "الكمية المتبقية مطلوبة",
          },
          {
            label: "التصنيف المالي",
            type: "number",
            name: "financialCategory",
            errorMessage: "التصنيف المالي مطلوب",
          },
          {
            label: "السعر",
            type: "number",
  ...
  DetailsWorkLine: {
    line: {
      title: "التقدم العام",
      alertMessage: "يرجى حساب التقدم لعرض التقدم العام",
      widgets: {
        qcPoints: "نقاط QC",
        ncrs: "التقارير غير المطابقة",
        photos: "الصور",
        documents: "المستندات",
      },
      ...
      tabs: {
        ...
        photos: {
          ...
          text: "صور الموقع",
          addButton: "رفع صورة",
          noFoundMessage: "لا توجد صور",
          alerts: [
            "لم يتم قبول بعض الملفات. يُسمح فقط بملفات الصور.",
            "يمكنك تحميل ما يصل إلى 5 ملفات في المرة الواحدة. يرجى المحاولة مرة أخرى.",
            "فشل تنزيل الصورة. يرجى المحاولة مرة أخرى.",
          ],
          success: ["تم رفع الصورة بنجاح", "تم حذف الصورة بنجاح"],
        },
        docs: {
          title: "المستندات",
          text: "الوثائق",
          addButton: "إضافة مستند",
          noFoundMessage: "لا توجد مستندات",
          alerts: [
            "لم يتم قبول بعض الملفات. يُسمح فقط بملفات المستندات.",
            "يمكنك تحميل ما يصل إلى 3 ملفات في المرة الواحدة. يرجى المحاولة مرة أخرى.",
            "فشل تنزيل المستند. يرجى المحاولة مرة أخرى.",
          ],
          success: ["تم رفع المستند بنجاح", "تم حذف المستند بنجاح"],
        },
      },
    },
  },
  ...
  BusinessGuaranteeReportPage: {
    ...
    widgets: [
      {
        ...
        bgColor: "#dbeafe",
        valueColor: "#0084d1",
        text: "إجمالي الضمان التجاري",
        value: "{{alertValue}}",
        subText: `النسبة {{businessGuarantee}}%`,
      },
      {
        icon: IoAlertCircleOutline,
        textColor: "#e7000b",
      ...
      },
      {
        ...
        bgColor: "#dbfce7",
        valueColor: "#008235",
        text: "الضمان التجاري المتاح",
        value: "{{availableBusinessGuarantee}}",
        subText: `المتبقي {{remaining}}%`,
      },
      {
        icon: IoTimeOutline,
        textColor: "#e12afb",
        bgColor: "#f3e8ff",
        valueColor: "#9810fa",
        text: "مدة الضمان التجاري",
        value: "{{businessGuaranteeDuration}}",
        subText: `من {{availableBusinessGuaranteeDuration}}`,
      },
    ],
    table1: {
      columns: [
      ...
      title: "تفاصيل خصومات الضمان التجاري",
      total: "الإجمالي",
    },
    table2: {
      title: "مطالبات الضمان التجاري",
      total: "الإجمالي",
      addButton: "إضافة مطالبة",
      columns: [
        "رقم المطالبة",
        "التاريخ",
        "الوصف",
    ...
    messages: {
      noBusinessGuarantee: "لم يتم العثور على ضمان تجاري",
      noClaims: "لم يتم العثور على مطالبات.",
      deleteClaim: "تم حذف المطالبة بنجاح",
      noWorkConfirmation: "لم يتم العثور على تأكيد عمل.",
