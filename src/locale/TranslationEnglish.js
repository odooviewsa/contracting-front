      ...
      tabs: {
        ...
        quality: {
          ...
          form: {
            ...
            category: "Category",
            repeatedIssue: "Repeated Issue",
            qualityEngineer: "Quality Engineer",
            itp: "ITP %",
            note: "Note",
            description: "Detailed Description",
            attachments: "Attachments",
            submit: "Submit Quality Check",
            save: "Save Draft",
            ...
            placeholders: {
              ...
              date: "Select a date",
              noteRelation: "Choose a relation",
              correctionStatus: "Select correction status",
              category: "Select category",
              repeatedIssue: "Is this issue repeated?",
              qualityEngineer: "Enter engineer's name",
              itp: "Enter ITP percentage",
              note: "Write your note here",
              description: "Provide a detailed description",
              assignedTo: "Select assigned to",
              qualityEngineer: "Select quality engineer",
              managerFeedback: "Write your feedback here",
            },
            errorMessages: {
              project: "Project name is required",
              contract: "Contract name is required",
              date: "Date is required",
              noteRelation: "Please select a note relation",
              correctionStatus: "Please select a correction status",
              category: "Please choose a category",
              repeatedIssue: "Please specify if the issue is repeated",
              qualityEngineer: "Quality engineer name is required",
              itp: "ITP percentage is required",
              note: "Note cannot be empty",
              description: "Description is required",
              assignedTo: "Please select user assigned to this issue",
              qualityEngineer: "Please select a quality engineer",
              managerFeedback: "Please enter a feedback",
            },
            options: {
              noteRelation: [
              ...
              correctionStatus: [
                { value: "ncr-released", text: "NCR Released" },
                { value: "ncr-not-released", text: "NCR Not Released" },
