...
const AddPartner = ({ setOpenPartner, refetch }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      t("AddPartnerForm.fields", { returnObjects: true }).forEach((field) => {
      ...
      await axiosInstance
        .post(`/api/partners/create`, formData)
        .then((result) => {
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {t("AddPartnerForm.fields", { returnObjects: true }).map(
                (field) => {
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    {t("AddPartnerForm.addButton.loading")}
                  </>
                ) : (
                  t("AddPartnerForm.addButton.text")
                )}
              </button>
            </div>
          </form>
